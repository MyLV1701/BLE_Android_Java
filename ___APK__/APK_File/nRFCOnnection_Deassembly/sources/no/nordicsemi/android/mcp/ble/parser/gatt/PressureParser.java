...
public class PressureParser implements ICharacteristicParser {
    ...
    private static String parse(byte[] bArr, int i) {
        return String.format(Locale.US, "%.1f Pa", Float.valueOf(ParserUtils.getIntValue(bArr, 20, i) / 10.0f));
    }
}
