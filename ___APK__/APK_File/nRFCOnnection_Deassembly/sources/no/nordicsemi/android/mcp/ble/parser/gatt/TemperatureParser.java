...
public class TemperatureParser implements ICharacteristicParser {
    ...
    private static String parse(byte[] bArr, int i) {
        return String.format(Locale.US, "%.2f℃", Float.valueOf(ParserUtils.getIntValue(bArr, 34, i) / 100.0f));
    }
}
