...
public class VelocityMPSParser implements ICharacteristicParser {
    ...
    private static String parse(byte[] bArr, int i) {
        return String.format(Locale.US, "%.2f m/s", Float.valueOf(ParserUtils.getIntValue(bArr, 18, i) / 100.0f));
    }
}
