...
public class UIntParser implements ICharacteristicParser {
    ...
    private static String parse(byte[] bArr, int i, int i2, String str) {
        ...
        if (i2 == 2) {
            return String.valueOf(ParserUtils.getIntValue(bArr, 18, i)) + str2;
        }
        if (i2 == 3) {
            return String.valueOf(ParserUtils.getIntValue(bArr, 19, i)) + str2;
        }
        if (i2 == 4) {
            return String.valueOf(ParserUtils.getIntValue(bArr, 20, i)) + str2;
        }
        if (i2 != 16) {
