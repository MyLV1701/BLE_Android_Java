...
public class PollenConcentrationParser implements ICharacteristicParser {
    ...
    private static String parse(byte[] bArr, int i) {
        return String.format(Locale.US, "%d / m³", Integer.valueOf(ParserUtils.getIntValue(bArr, 19, i)));
    }
}
