...
public class OnOffDialogBuilder extends WriteDialogBuilder {
    ...
    protected View createView(Context context) {
        ...
        radioButton.setText(R.string.write_off);
        radioButton.setChecked(true);
        ((RadioButton) inflate.findViewById(R.id.option_2)).setText(R.string.write_on);
