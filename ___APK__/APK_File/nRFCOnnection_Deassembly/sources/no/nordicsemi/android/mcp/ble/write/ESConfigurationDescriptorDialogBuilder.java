...
public class ESConfigurationDescriptorDialogBuilder extends WriteDialogBuilder {
    ...
    protected View createView(Context context) {
        ...
        radioButton.setText(R.string.es_and);
        radioButton.setChecked(true);
        ((RadioButton) inflate.findViewById(R.id.option_2)).setText(R.string.es_or);
