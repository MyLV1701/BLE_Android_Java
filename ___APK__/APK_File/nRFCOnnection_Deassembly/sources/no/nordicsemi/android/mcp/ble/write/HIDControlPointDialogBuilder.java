...
public class HIDControlPointDialogBuilder extends WriteDialogBuilder {
    ...
    protected View createView(Context context) {
        ...
        radioButton.setText(R.string.write_hid_control_point_suspended);
        radioButton.setChecked(true);
        ((RadioButton) inflate.findViewById(R.id.option_2)).setText(R.string.write_hid_control_point_exit_suspended);
