...
public class IrradianceParser implements ICharacteristicParser {
    ...
    private static String parse(byte[] bArr, int i) {
        return String.format(Locale.US, "%.1f W/m", Float.valueOf(ParserUtils.getIntValue(bArr, 18, i) / 10.0f));
    }
}
