...
abstract class ButtonlessDfuImpl extends BaseButtonlessDfuImpl {
    ...
    public void performDfu(Intent intent) {
        ...
        try {
            ...
            int errorNumber = e2.getErrorNumber() | DfuBaseService.ERROR_REMOTE_TYPE_SECURE_BUTTONLESS;
            loge(e2.getMessage());
            this.mService.sendLogBroadcast(20, String.format(Locale.US, "Remote DFU error: %s", c.b(errorNumber)));
