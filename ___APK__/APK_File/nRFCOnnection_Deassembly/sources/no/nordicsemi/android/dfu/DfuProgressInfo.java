...
class DfuProgressInfo {
    ...
    public float getSpeed() {
        long elapsedRealtime = SystemClock.elapsedRealtime();
        float f2 = elapsedRealtime - this.timeStart != 0 ? (this.bytesSent - this.lastBytesSent) / ((float) (elapsedRealtime - this.lastProgressTime)) : 0.0f;
    ...
    public DfuProgressInfo init(int i, int i2, int i3) {
        ...
        this.maxObjectSizeInBytes = Preference.DEFAULT_ORDER;
        this.currentPart = i2;
        this.totalParts = i3;
        return this;
    }
