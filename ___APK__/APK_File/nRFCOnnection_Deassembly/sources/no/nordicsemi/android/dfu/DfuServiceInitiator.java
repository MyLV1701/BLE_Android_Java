...
public final class DfuServiceInitiator {
    ...
    @Deprecated
    public DfuServiceInitiator setBinOrHex(@FileType int i, Uri uri) {
        if (i != 0) {
    ...
    @Deprecated
    public DfuServiceInitiator setBinOrHex(@FileType int i, String str) {
        if (i != 0) {
    ...
    @Deprecated
    public DfuServiceInitiator setBinOrHex(@FileType int i, Uri uri, String str) {
        if (i != 0) {
    ...
    private DfuServiceInitiator init(Uri uri, String str, int i, @FileType int i2, String str2) {
        this.fileUri = uri;
        this.filePath = str;
        this.fileResId = i;
        this.fileType = i2;
    ...
    @Deprecated
    public DfuServiceInitiator setBinOrHex(@FileType int i, int i2) {
        if (i != 0) {
