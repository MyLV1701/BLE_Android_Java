...
final class Recreator implements e {
    ...
    public void a(j jVar, g.a aVar) {
        if (aVar == g.a.ON_CREATE) {
            ...
            Bundle a2 = this.f1942a.getSavedStateRegistry().a("androidx.savedstate.Restarter");
            if (a2 == null) {
                return;
            }
    ...
    static final class a implements SavedStateRegistry.b {
        ...
        /* renamed from: a, reason: collision with root package name */
        final Set<String> f1943a = new HashSet();
        ...
        public Bundle a() {
            ...
            bundle.putStringArrayList("classes_to_restore", new ArrayList<>(this.f1943a));
            return bundle;
        }
    ...
    private void a(String str) {
        try {
            ...
            try {
                ...
                try {
                    ((SavedStateRegistry.a) declaredConstructor.newInstance(new Object[0])).a(this.f1942a);
                } catch (Exception e2) {
