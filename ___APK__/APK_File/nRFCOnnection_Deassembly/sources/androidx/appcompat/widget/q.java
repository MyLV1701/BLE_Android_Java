...
class q {
    ...
    private static final int[] f1074c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: a, reason: collision with root package name */
    private final ProgressBar f1075a;

    /* renamed from: b, reason: collision with root package name */
    private Bitmap f1076b;
    ...
    public void a(AttributeSet attributeSet, int i) {
        t0 a2 = t0.a(this.f1075a.getContext(), attributeSet, f1074c, i, 0);
        Drawable c2 = a2.c(0);
        if (c2 != null) {
            this.f1075a.setIndeterminateDrawable(a(c2));
        }
        Drawable c3 = a2.c(1);
        if (c3 != null) {
            this.f1075a.setProgressDrawable(a(c3, false));
        }
        a2.a();
    }
