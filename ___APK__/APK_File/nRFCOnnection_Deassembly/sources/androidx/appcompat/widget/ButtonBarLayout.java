...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f878b = obtainStyledAttributes.getBoolean(a.a.j.ButtonBarLayout_allowStacking, true);
    ...
    public int getMinimumHeight() {
        return Math.max(this.f880d, super.getMinimumHeight());
    }
    ...
    public void setAllowStacking(boolean z) {
        if (this.f878b != z) {
            this.f878b = z;
            if (!this.f878b && getOrientation() == 1) {
                setStacked(false);
            }
            requestLayout();
        }
