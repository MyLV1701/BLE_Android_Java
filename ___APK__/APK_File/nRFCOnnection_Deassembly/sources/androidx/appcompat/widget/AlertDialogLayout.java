    ...
    private void c(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                e0.a aVar = (e0.a) childAt.getLayoutParams();
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == a.a.f.topPanel) {
                    ...
                    if ((id != a.a.f.contentPanel && id != a.a.f.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = a.f.l.w.q(r17)
            int r2 = a.f.l.d.a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L97
            r3 = 5
