...
public class h {
    ...
    private final a.d.g<String, i> f2106a = new a.d.g<>();

    /* renamed from: b, reason: collision with root package name */
    private final a.d.g<String, PropertyValuesHolder[]> f2107b = new a.d.g<>();
    ...
    public boolean b(String str) {
        return this.f2106a.get(str) != null;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof h) {
            return this.f2106a.equals(((h) obj).f2106a);
        }
        return false;
    }
    ...
    public String toString() {
        return '\n' + h.class.getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f2106a + "}\n";
    }

    public void a(String str, i iVar) {
        this.f2106a.put(str, iVar);
    }

    public void a(String str, PropertyValuesHolder[] propertyValuesHolderArr) {
        this.f2107b.put(str, propertyValuesHolderArr);
    }
