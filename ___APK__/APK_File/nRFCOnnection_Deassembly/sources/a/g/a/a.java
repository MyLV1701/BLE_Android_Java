...
public abstract class a extends BaseAdapter implements Filterable, b.a {
    ...
    protected C0020a mChangeObserver;
    protected Context mContext;
    protected Cursor mCursor;
    protected a.g.a.b mCursorFilter;
    ...
    public Filter getFilter() {
        if (this.mCursorFilter == null) {
            this.mCursorFilter = new a.g.a.b(this);
        }
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        if (cursor2 != null) {
            C0020a c0020a = this.mChangeObserver;
            if (c0020a != null) {
        ...
        this.mCursor = cursor;
        if (cursor != null) {
            C0020a c0020a2 = this.mChangeObserver;
            if (c0020a2 != null) {
    ...
    void init(Context context, Cursor cursor, int i) {
        ...
        if ((i & 2) == 2) {
            this.mChangeObserver = new C0020a();
