...
public class b {
    ...
    public static class C0008b {
        ...
        C0008b(char c2, float[] fArr) {
            this.f165a = c2;
            this.f166b = fArr;
        }

        public static void a(C0008b[] c0008bArr, Path path) {
            float[] fArr = new float[6];
            char c2 = 'm';
            for (int i = 0; i < c0008bArr.length; i++) {
                a(path, fArr, c2, c0008bArr[i].f165a, c0008bArr[i].f166b);
                c2 = c0008bArr[i].f165a;
            }
        }

        C0008b(C0008b c0008b) {
            this.f165a = c0008b.f165a;
            float[] fArr = c0008b.f166b;
            this.f166b = b.a(fArr, 0, fArr.length);
        }

        public void a(C0008b c0008b, C0008b c0008b2, float f2) {
            this.f165a = c0008b.f165a;
            int i = 0;
            while (true) {
                float[] fArr = c0008b.f166b;
                ...
                this.f166b[i] = (fArr[i] * (1.0f - f2)) + (c0008b2.f166b[i] * f2);
                i++;
            }
        }
    ...
    public static void b(C0008b[] c0008bArr, C0008b[] c0008bArr2) {
        for (int i = 0; i < c0008bArr2.length; i++) {
            c0008bArr[i].f165a = c0008bArr2[i].f165a;
            for (int i2 = 0; i2 < c0008bArr2[i].f166b.length; i2++) {
                c0008bArr[i].f166b[i2] = c0008bArr2[i].f166b[i2];
            }
        }
    }
    ...
    public static C0008b[] a(String str) {
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                a((ArrayList<C0008b>) arrayList, trim.charAt(0), c(trim));
            }
            i2 = a2;
            i = a2 + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            a((ArrayList<C0008b>) arrayList, str.charAt(i2), new float[0]);
        }
    ...
    public static boolean a(C0008b[] c0008bArr, C0008b[] c0008bArr2) {
        if (c0008bArr == null || c0008bArr2 == null || c0008bArr.length != c0008bArr2.length) {
            return false;
        }
        for (int i = 0; i < c0008bArr.length; i++) {
            if (c0008bArr[i].f165a != c0008bArr2[i].f165a || c0008bArr[i].f166b.length != c0008bArr2[i].f166b.length) {
                return false;
            }
        }
        return true;
    ...
    private static void a(ArrayList<C0008b> arrayList, char c2, float[] fArr) {
        arrayList.add(new C0008b(c2, fArr));
    }
    ...
    */
    private static void a(java.lang.String r8, int r9, a.f.e.b.a r10) {
        /*
            r0 = 0
            r10.f164b = r0
            r1 = r9
        ...
        L3d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.f.e.b.a(java.lang.String, int, a.f.e.b$a):void");
    }
}
